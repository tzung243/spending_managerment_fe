...
const DashboardLayout = (props) => {
  ...
  let wrapperClass = classNames("layout-wrapper", {
    ...
    "layout-static-sidebar-inactive":
      staticMenuInactive && state.layoutMode === "static",
    "layout-overlay-sidebar-active":
      overlayMenuActive && state.layoutMode === "overlay",
  ...
  return (
    <div className={wrapperClass}>
      ...
      <div
        ...
        style={{ minHeight: "100vh", marginBottom: "-55px" }}
      >
        <Switch>
          <PrivateRoute
            exact
          ...
          <PrivateRoute
            exact
            strict
            path={"/expense/category/:category_id/edit"}
          ...
          <PrivateRoute
            exact
            strict
            path={"/income/category/:category_id/edit"}
        ...
        <div style={{ height: "55px" }}>{/* For footer adjustment */}</div>
        <ScrollToTop />
      </div>
      <AppFooter />
